			...
			<div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
				...
				>
					...
					<p class="mt-6 text-lg text-gray-600">
						...
						profit, and exactly when to sell to avoid painful
						losses.
					</p>
		...
		<div class="mt-16 md:hidden">
					...
					>
								...
								<div class="flex flex-col w-full">
									...
									<div class="mt-6 px-4 text-white">
										...
										<div class="text-sm text-gray-500">
											Get tips <span class="text-white"
												>5s sooner</span
											> for every invite.
										</div>
									</div>
						...
						>
							...
							<p class="mt-2 text-sm text-gray-400">
								For every friend you invite to Pocket, you get
								insider notifications 5 seconds sooner. And it’s
								10 seconds if you invite an insider.
							</p>
						</div>
					</div>
				</div>
					...
					>
						...
						>
							...
							<p class="mt-2 text-sm text-gray-400">
								...
								something that’s going to lower the share price
								on your holdings so you can sell before the
					...
					>
						...
						>
							...
							<p class="mt-2 text-sm text-gray-400">
								...
								anonymous trading accounts, so suspicious
								activity can never be traced back to you.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="mt-6 flex justify-center gap-3">
				<button
					...
					><span class="absolute -inset-x-1.5 -inset-y-3" /></button
				><button
					type="button"
				...
				<li class="rounded-2xl border border-gray-200 p-8">
					<svg
						...
						/><circle cx="11" cy="14" r="2" fill="#171717" /><circle
							...
							r="2"
							fill="#171717"
						/><circle cx="11" cy="26" r="2" fill="#171717" /><path
			...
			>
				...
				>
					...
					<p class="mt-3 text-sm text-gray-300">
						You’ve got a huge amount of assets but it’s not enough.
						To the moon.
					</p>
					<div class="order-last mt-6">
						<ul
					...
					<ul role="list" class="space-y-10">
						...
						<li>
							...
							<p class="mt-4 text-sm text-gray-700">
								...
								could only make insider trades with knowledge
								from your direct network. Pocket brings you
								insider trading tips from people you don’t even
								know.
							</p>
						</li>
						<li>
							...
							<p class="mt-4 text-sm text-gray-700">
								...
								insider trading, not us. We’re just giving you
								the tips and some tools to make trades. We’re
					...
					<ul role="list" class="space-y-10">
						<li>
							<h3
								class="text-lg font-semibold leading-6 text-gray-900"
							>
								Do the people giving you tips realize what they
								are doing?
							</h3>
							<p class="mt-4 text-sm text-gray-700">
								Again I would argue this isn’t really our
								responsibility. People make their own choices.
								If they don’t research the consequences that’s
								on them, not on us.
							</p>
						</li>
						<li>
							...
							<p class="mt-4 text-sm text-gray-700">
								Let’s just say it’s not somewhere where the SEC
								is going to find us.
							</p>
						</li>
						<li>
							...
							<p class="mt-4 text-sm text-gray-700">
								...
								minimum age to trade in your country of
								residence. Our VIP plan uses advanced
								transaction anonymization though, so you can use
								that plan even if you’re 9 years old. Or a dog.
							</p>
						</li>
					</ul>
				</li>
				<li>
					<ul role="list" class="space-y-10">
						<li>
							...
							<p class="mt-4 text-sm text-gray-700">
								Honestly we were surprised too, but eventually
								we found out that the app reviewer found the app
								so compelling they approved it just so they
						...
						<li>
							...
							<p class="mt-4 text-sm text-gray-700">
								...
								problem. Pocket is not responsible in any way
						...
						<li>
							...
							<p class="mt-4 text-sm text-gray-700">
								Contact us with some details about your industry
								and the type of access you have to apply for an
								insider account. Once approved, we’ll send you a
								guide on collecting insider information without
								being detected at work.
							</p>
						</li>
					</ul>
				</li>
